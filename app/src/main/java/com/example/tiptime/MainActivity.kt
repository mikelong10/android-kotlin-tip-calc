...
fun TipTimeLayout() {
    ...
    val tip = calculateTip(amount, tipPercentage, roundUpTip)
    ...
    Column(
        ...
        RoundUpTipRow(shouldRoundUp = roundUpTip, onShouldRoundUpChange = { roundUpTip = it })
        Text(
...
fun RoundUpTipRow(
    ...
    onShouldRoundUpChange: (Boolean) -> Unit,
    modifier: Modifier = Modifier
) {
    Row(
        ...
        Switch(checked = shouldRoundUp, onCheckedChange = onShouldRoundUpChange)
    }
}
